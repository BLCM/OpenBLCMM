/*
 * Copyright (C) 2009 Rob Camick
 *
 * Found at: https://tips4java.wordpress.com/2009/12/20/scrollable-panel/
 *
 * The license given for code on the site can be found here:
 * https://tips4java.wordpress.com/about/
 *
 * From that page: "We assume no responsibility for the code. You are free to
 * use and/or modify and/or distribute any or all code provided via the Java
 * Tips Weblog without restriction. A credit in the code comments would be nice,
